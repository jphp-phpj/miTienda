...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['confirm']) && $_POST['confirm'] == 1) {
        ...
        $msg = 'Ingrese al menos 5 caracteres en el nombre de la persona';
            ...
            $res = $mbd->prepare("UPDATE personas SET nombre = ?, rut = ?, email = ?, direccion = ?, fecha_nac = ?, 
            telefono = ?, rol_id = ?, comuna_id = ?, updated_at = now() WHERE id = ? ");
                ...
                <?php if($persona): ?>
                    <form action="" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="rut" value="<?php echo $persona['rut']; ?>" 
                                class="form-control" placeholder="Ingrese el RUT de la persona">
                        </div>
                        <div class="form-group mb-3">
                            <label for="">Email <span class="text-danger">*</span></label>
                            <input type="email" name="email" value="<?php echo $persona['email']; ?>" 
                                class="form-control" placeholder="Ingrese el email de la persona">
                        </div>
                        <div class="form-group mb-3">
                            <label for="">Dirección <span class="text-danger">*</span></label>
                            <input type="text" name="direccion" value="<?php echo $persona['direccion']; ?>" 
                                class="form-control" placeholder="Ingrese la dirección de la persona (calle y número)">
                        </div>
                        <div class="form-group mb-3">
